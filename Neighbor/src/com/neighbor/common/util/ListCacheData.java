...
public final class ListCacheData<E> implements Serializable
{
	...
	public ListCacheData(List<E> data)
	{
		this.totalRecordCount = data.size();
		this.ls = new CircleListNoSafe<E>(data, data.size());
	}
...
*/
	...
	public CircleListNoSafe<E> getLs() {
		return ls;
	}

	public void setLs(CircleListNoSafe<E> ls) {
		this.ls = ls;
	}
}
